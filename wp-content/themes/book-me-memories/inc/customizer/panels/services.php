<?php
// Set Panel ID
$panel_id = 'book-me-memories_panel_services';
...
$wp_customize->add_section( $panel_id, array(
		...
		'theme_supports' => '',
		'title'          => __( 'Services Section', 'book-me-memories' ),
		'description'    => __( 'Control various options for services section from front page.', 'book-me-memories' ),
...
$wp_customize->add_setting( $prefix . '_services_general_title', array(
		...
		'default'           => __( 'Services', 'book-me-memories' ),
		'transport'         => 'postMessage',
	) );
...
if ( get_theme_mod( $prefix . '_services_general_entry' ) ) {
	...
	$wp_customize->add_setting( $prefix . '_services_general_entry', array(
			...
			'default'           => __( 'In order to help you grow your business, our carefully selected experts can advise you in in the following areas:', 'book-me-memories' ),
			'transport'         => 'postMessage',
		) );
...
$wp_customize->add_control(
    new Epsilon_Control_Button(
        ...
        array(
            'text'         => __( 'Add & Edit Services', 'book-me-memories' ),
