...
(function ( $ ) {
 ...
 jQuery( document ).ready( function( $ ) {
 	...
 	function illdy_sections_order( container ){
 		...
 		$.ajax({
			url: Book Me MemoriesCustomizer.ajax_url,
			type: 'post',
			dataType: 'html',
			data: {
    ...
    jQuery(".illdy-dismiss-required-action").click(function () {
        ...
        jQuery.ajax({
            ...
            beforeSend: function (data, settings) {
                jQuery('#' + id).parent().append('<div id="temp_load" style="text-align:center"><img src="' + Book Me MemoriesCustomizer.template_directory + '/inc/admin/welcome-screen/img/ajax-loader.gif" /></div>');
            },
