		...
		if ( is_admin() ) {
			...
			$illdy_required_actions = array(
				array(
					...
					"title"       => MT_Notify_System::create_plugin_title( __( 'Book Me Memories Companion', 'illdy' ), 'illdy-companion' ),
					"description" => __( 'It is highly recommended that you install the Book Me Memories Companion.', 'illdy' ),
