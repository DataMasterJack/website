...
if( !function_exists( 'Book Me Memories_CallRelatedPostsClass' ) ) {
    /**
     *
    ...
    function Book Me Memories_CallRelatedPostsClass()
    {
        ...
        if ($display_related_blog_posts == 1) {
            ...
            Book Me Memories_Related_Posts_Output::getInstance();
        }
    }
    add_action( 'wp_loaded', 'Book Me Memories_CallRelatedPostsClass');
}


if( !class_exists( 'Book Me Memories_Related_Posts_Output' ) ) {
